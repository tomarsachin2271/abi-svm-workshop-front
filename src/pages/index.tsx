...
export default function Home() {
  ...
  const connect = async () => {
    ...
    try {
      ...
      const bicoToken = new ethers.Contract(
        "0x48d3E8EDd4cdD81E4B4eea678Ab167E1988B63F2",
        erc20Abi,
        provider
      );
      ...
      <main className={styles.main}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p>Rewards Earned: {rewardsEarned} {bicoToken && <p>Update in: {countdown} seconds</p> }</p>
